    ...
    public partial class CreateDatabaseAndAddInitialData : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Users", t => t.Account_Id)
            ...
            Sql("INSERT INTO Users VALUES('mdabujen@gmail.com', 'password', 'Mark Denver', 'Abujen')");
        }
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Backups", "Account_Id", "dbo.Users");
